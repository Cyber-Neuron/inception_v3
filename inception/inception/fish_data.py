...
# ==============================================================================
"""Small library that points to the fish data set.
"""
...
class FishData(Dataset):
  ...
  def download_message(self):
    """Instruction to download and extract the tarball from Fish website."""

    print('Failed to find any Fish %s files'% self.subset)
    print('')
    ...
    print('Please see README.md for instructions on how to build '
          'the fish dataset using download_and_preprocess_fish.\n')
